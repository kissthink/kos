...
asm(".globl return_to_prog");
asm("return_to_prog:");
asm("       movw registers+88,  %ss");
asm("       movq registers+32,  %rsp");
...
asm("       movw registers+96,  %ds");
asm("       movw registers+104, %es");
asm("       movw registers+112, %fs");
asm("       movw registers+120, %gs");
asm("       movq registers+72,  %rax");
asm("       pushq %rax");   /* saved eflags */
asm("       movq registers+80,  %rax");
asm("       pushq %rax");   /* saved cs */
asm("       movq registers+64,  %rax");
