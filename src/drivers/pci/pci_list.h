...
typedef struct _PCI_VENTABLE
{
	...
	const char *	VendorIdShort ;
	const char *	VendorFull ;
}  PCI_VENTABLE, *PPCI_VENTABLE ;

PCI_VENTABLE	PCIVendorTable [] =
{
...
#define	PCI_VENTABLE_LEN	(sizeof(PCIVendorTable)/sizeof(PCI_VENTABLE))
...
// Use this value for loop control during searching:
#define	PCI_DEVTABLE_LEN	(sizeof(PCIDeviceTable)/sizeof(PCI_DEVTABLE))
