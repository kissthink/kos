...
File* NetManager::newEndpoint(int type, int protocol)
{
    ...
    {
        DBG::outln(DBG::Error, "NetManager::getEndpoint called with unknown protocol");
    }
...
{
    DBG::outln(DBG::Error, "Old-style call (removeEndpoint)");
    return;
...
{
    DBG::outln(DBG::Error, "Old-style call (getEndpoint)");
    return 0;
