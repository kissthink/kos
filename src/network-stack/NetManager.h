...
#ifndef _NetworkStack_NetManager_h_
#define _NetworkStack_NetManager_h_ 1
...
class Socket : public File
{
  private:
    ...
    {
      DBG::outln(DBG::Error, "Socket copy constructor called");
    };
  ...
  public:
    ...
    virtual int select(bool bWriting = false, int timeout = 0)
    {
        ...
        if(m_Endpoint->getType() == Endpoint::Connectionless)
        {
            ...
            {
                DBG::outln(DBG::Net, "Checking for data...");
                bool ret = ce->dataReady(timeout > 0, timeout);
                DBG::outln(DBG::Net, "Data ready: ", ret, ".");
                return ret ? 1 : 0;
            }
        }
...
#endif /* _NetworkStack_NetManager_h_ */
